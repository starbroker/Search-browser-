...
if (envFile.exists()) {
    envFile.readLines().forEach {
        if (it.startsWith("GROQ_API_KEY=")) {
            groqApiKey = it.substringAfter("=")
        }
        if (it.startsWith("GROQ_API_KEY_2=")) {
            groqApiKey2 = it.substringAfter("=")
        }
        if (it.startsWith("GROQ_API_KEY_3=")) {
            groqApiKey3 = it.substringAfter("=")
        }
    }
}
...
android {
    defaultConfig {
        ...
        buildConfigField("String", "GROQ_API_KEY_2", "\"${groqApiKey2}\"")
        buildConfigField("String", "GROQ_API_KEY_3", "\"${groqApiKey3}\"")
    }
}
