...
object BrowserTranslator {
    val TRANSLATIONS = mapOf(
        "简体中文" to mapOf(
            ...
            "Appearance" to "外观",
            "Dark Mode" to "深色模式",
            "Search engines" to "搜索引擎",
            "OS Permissions Denied" to "操作系统权限被拒绝",
            "What's New" to "新功能",
            "Got it" to "知道了",
            "Reduced APK Size" to "减小了APK体积",
            "Fast compile speeds" to "编译速度更快",
            "Removed buggy tools" to "移除错误工具",
            "Update welcome UI" to "更新欢迎界面",
        ...
        "Español" to mapOf(
            ...
            "Search engines" to "Motores de búsqueda",
            "OS Permissions Denied" to "Permisos del SO denegados",
            "What's New" to "Novedades",
            "Got it" to "Entendido",
            "Reduced APK Size" to "Tamaño de APK reducido",
            "Fast compile speeds" to "Compilación rápida",
            "Removed buggy tools" to "Herramientas con errores eliminadas",
            "Update welcome UI" to "Interfaz de bienvenida actualizada",
        ...
        "Deutsch" to mapOf(
            ...
            "Search engines" to "Suchmaschinen",
            "OS Permissions Denied" to "OS-Berechtigungen verweigert",
            "What's New" to "Was gibt's Neues",
            "Got it" to "Verstanden",
            "Reduced APK Size" to "Reduzierte APK-Größe",
            "Fast compile speeds" to "Schnelle Kompilierzeiten",
            "Removed buggy tools" to "Fehlerhafte Werkzeuge entfernt",
            "Update welcome UI" to "Willkommens-UI aktualisiert",
        ...
        "Français" to mapOf(
            ...
            "Search engines" to "Moteurs de recherche",
            "OS Permissions Denied" to "Autorisations du système d'exploitation refusées",
            "What's New" to "Nouveautés",
            "Got it" to "Compris",
            "Reduced APK Size" to "Taille de l'APK réduite",
            "Fast compile speeds" to "Vitesses de compilation rapides",
            "Removed buggy tools" to "Outils bogués supprimés",
            "Update welcome UI" to "Interface d'accueil mise à jour",
