...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val showOnboarding by browserViewModel.showOnboarding.collectAsState()
            val isDark = androidx.compose.foundation.isSystemInDarkTheme() || settings.themeMode == "DARK"
                ...
                androidx.compose.material3.Surface(
                    ...
                    if (showOnboarding) {
                        com.example.ui.OnboardingScreen(
                            ...
                            isDark = isDark,
                            onFinish = { browserViewModel.finishOnboarding() }
                        )
                    } else {
                        com.example.ui.BrowserScreen(viewModel = browserViewModel)
                    }
                }
            }
        }
